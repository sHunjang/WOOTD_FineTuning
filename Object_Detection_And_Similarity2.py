...
print(f"초기 최종 결합 유사도: {initial_combined_similarity}")

# 초기 유사도가 0.7 이상인 경우에만 객체 탐지 수행
if initial_combined_similarity >= 0.7:
    print("초기 유사도가 0.7 이상이므로 객체 탐지 및 상세 유사도 분석을 수행합니다.")
